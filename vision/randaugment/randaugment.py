...
class Cutout:
    ...
    def __call__(self, pil_img):
        ...
        img_height, img_width, num_channels = (*pil_img.size, 3)  # type: ignore
...
class SubPolicy(object):
    def __init__(
        ...
        # from "https://stackoverflow.com/questions/5252170/specify-image-filling  <- change line here
    ...
    def __repr__(self):
        return (
            f"{self._operation1_name} with p:{self.p1} and magnitude:{self.magnitude1} \t"
